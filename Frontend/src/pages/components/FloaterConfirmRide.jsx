...
const FloaterConfirmRide = ({rideDetails, setRideDetails,setWaiting}) => {
  ...
  return (
    <div className="home-container confirm-ride">
      <div
      ...
      >
        <div className='floater-inside'>
          <div className='floater-header'>
            ...
            <h2 className='floater-title'>Confirm Your Ride</h2>
          </div>
...
export default FloaterConfirmRide;
